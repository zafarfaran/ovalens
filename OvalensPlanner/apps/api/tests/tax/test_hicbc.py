...
def test_no_hicbc_below_60k():
    ...
    r = calculate_hicbc(55000, number_of_children=2)
...
def test_partial_clawback_70k():
    ...
    """
    r = calculate_hicbc(70000, number_of_children=2)
...
def test_full_clawback_80k():
    ...
    r = calculate_hicbc(80000, number_of_children=2)
    assert r.applies is True
...
def test_no_children():
    ...
    r = calculate_hicbc(80000, number_of_children=0)
    assert r.applies is False
    assert r.hicbc_charge == 0
...
def test_one_child_vs_two():
    ...
    r1 = calculate_hicbc(80000, number_of_children=1)
    r2 = calculate_hicbc(80000, number_of_children=2)
