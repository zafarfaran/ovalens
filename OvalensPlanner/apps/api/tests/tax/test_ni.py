...
def test_class_1_basic():
    ...
    """
    r = calculate_class_1_ni(30000)
    assert r.main_ni == 1394.40
    assert r.upper_ni == 0
    assert r.total_employee_ni == 1394.40
...
def test_class_1_above_uel():
    ...
    Total: 4010.60
    """
    r = calculate_class_1_ni(100000)
    assert r.main_ni == 3016.00
    assert r.upper_ni == 994.60
    assert r.total_employee_ni == 4010.60
...
def test_class_1_employer():
    ...
    """
    r = calculate_class_1_ni(30000)
    assert r.total_employer_ni == 3750.00
...
def test_class_4_basic():
    ...
    """
    r = calculate_class_4_ni(36000)
    assert r.main_ni == 1405.80
    assert r.upper_ni == 0
    assert r.total_ni == 1405.80
...
def test_class_4_above_upl():
    ...
    Total: 2856.60
    """
    r = calculate_class_4_ni(80000)
    assert r.main_ni == 2262.00
    assert r.upper_ni == 594.60
    assert r.total_ni == 2856.60
